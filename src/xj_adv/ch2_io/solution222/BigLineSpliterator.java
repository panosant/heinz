 ...
 */
public class BigLineSpliterator implements Spliterator<LineInFile> {
    ...
    @Override
    public boolean tryAdvance(Consumer<? super LineInFile> action) {
        long index = lo;
        ...
        action.accept(new LineInFile(lo, sb));
        lo = lo + sb.length() + 1;
        return lo < hi;
    }
    ...
    @Override
    public Spliterator<LineInFile> trySplit() {
